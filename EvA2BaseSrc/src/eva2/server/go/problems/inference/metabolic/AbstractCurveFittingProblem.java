...
public abstract class AbstractCurveFittingProblem extends
        AbstractProblemDouble implements InterfaceHasInitRange,
        Serializable {
...
//	protected double xOffSet, noise, yOffSet;
    ...
    protected transient int countEvals = 0;
...
//	}
     ...
     * procedure.
     *
     * @param mc If true, a Monte Carlo initialization will be performed. Else
    ...
    public double[] eval(double[] x) {
        countEvals++;
//		if (countEvals % 100 == 0) System.out.println(countEvals + " evals done!");
...
//				System.out.println(metabolites.get(i) + "\t" + fitness);
     ...
     *
     * @param x The current parameters of the differential equation describing
