...
//		CKMMrSystem sys = new CKMMrSystem();
//		int runs = 1000000;
...
//		for (int i=0; i<runs; i++) {
//			sys.getPyr_2_alt(-3.43);
//		}
//		System.out.println(System.currentTimeMillis() - time);
//		time = System.currentTimeMillis();
//		for (int i=0; i<runs; i++) {
//			sys.getPyr_2_altalt(-3.43);
//		}
//		System.out.println(System.currentTimeMillis() - time);
//		time = System.currentTimeMillis();
//		for (int i=0; i<runs; i++) {
//			sys.getPyr_2_hashed(-3.43);
//		}
//		System.out.println(System.currentTimeMillis() - time);
//		time = System.currentTimeMillis();
//		System.out.println(sys.getPyr_2(-3.43));		
//		System.out.println(sys.getPyr_2_alt(-3.43));		
//		System.out.println(sys.getPyr_2_altalt(-3.43));
//		System.out.println(sys.getPyr_2_hashed(-3.43));
