 ...
 */
public class PropertyPortfolioSelectionWeightAggregatedObjectivesEditor extends JPanel implements PropertyEditor, java.beans.PropertyChangeListener {
     ...
     */
    private PropertyPortfolioSelectionWeightAggregatedObjectives m_OptimizationTargetsWithWeights;
    ...
    public PropertyPortfolioSelectionWeightAggregatedObjectivesEditor() {
        m_self = this;
    }
    ...
    private void initCustomEditor() {
        ...
        // init the editors
        InterfacePortfolioSelectionObjective[] list = this.m_OptimizationTargetsWithWeights.getSelectedTargets();
        ...
        normButton.setEnabled(this.m_OptimizationTargetsWithWeights.isNormalizationEnabled());
        ...
        jt.setText(this.m_OptimizationTargetsWithWeights.getDescriptiveString());
    ...
    private void updateTargetList() {
        ...
        byte[] bytes;
        InterfacePortfolioSelectionObjective[] list = this.m_OptimizationTargetsWithWeights.getSelectedTargets();
        double[] weights = this.m_OptimizationTargetsWithWeights.getWeights();
        ...
        gbc.gridx = 0;
        gbc.weightx = 2;
        this.m_TargetList.add(new JLabel(this.m_OptimizationTargetsWithWeights.getWeigthsLabel()), gbc);
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.BOTH;
        gbc.gridx = 1;
        gbc.weightx = 10;
    ...
    ActionListener addTarget = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            m_OptimizationTargetsWithWeights.addTarget((InterfacePortfolioSelectionObjective) m_OptimizationTargetsWithWeights.getAvailableTargets()[0].clone());
            int l = m_OptimizationTargetsWithWeights.getSelectedTargets().length;
            GeneralGOEProperty[] newEdit = new GeneralGOEProperty[l];
            for (int i = 0; i < m_Editors.length; i++) {
                newEdit[i] = m_Editors[i];
            }
            InterfacePortfolioSelectionObjective[] list = m_OptimizationTargetsWithWeights.getSelectedTargets();
            l--;
    ...
    ActionListener deleteTarget = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            int l = m_OptimizationTargetsWithWeights.getSelectedTargets().length, j = 0;
            GeneralGOEProperty[] newEdit = new GeneralGOEProperty[l - 1];
            for (int i = 0; i < m_Delete.length; i++) {
                if (event.getSource().equals(m_Delete[i])) m_OptimizationTargetsWithWeights.removeTarget(i);
                else {
    ...
    ActionListener normalizeWeights = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            double[] newW = m_OptimizationTargetsWithWeights.getWeights();
            double sum = 0;
            ...
            if (sum != 0) {
                ...
                m_OptimizationTargetsWithWeights.setWeights(newW);
            }
            updateTargetList();
        }
    };
    ...
    public void setValue(Object o) {
        if (o instanceof PropertyPortfolioSelectionWeightAggregatedObjectives) {
            this.m_OptimizationTargetsWithWeights = (PropertyPortfolioSelectionWeightAggregatedObjectives) o;
            this.updateEditor();
        }
    }
    ...
    public Object getValue() {
        return this.m_OptimizationTargetsWithWeights;
    }
    ...
    public void paintValue(Graphics gfx, Rectangle box) {
        ...
        String rep = "Weighted Portfolio Selection Objectives";
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        m_Support.firePropertyChange("", m_OptimizationTargetsWithWeights, m_OptimizationTargetsWithWeights);
    }
}