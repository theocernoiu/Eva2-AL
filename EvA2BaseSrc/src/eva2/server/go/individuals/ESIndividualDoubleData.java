...
import eva2.server.go.operators.crossover.CrossoverESArithmetical;
import eva2.server.go.operators.crossover.CrossoverESBLXAlpha;
...
public class ESIndividualDoubleData extends AbstractEAIndividual implements InterfaceESIndividual, InterfaceDataTypeDouble, java.io.Serializable {
    ...
    public ESIndividualDoubleData() {
        ...
        this.m_CrossoverOperator = new CrossoverESBLXAlpha();
