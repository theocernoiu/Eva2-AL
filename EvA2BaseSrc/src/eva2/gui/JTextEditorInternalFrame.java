...
public class JTextEditorInternalFrame extends JDocFrame {
    ...
    private class UndoAction extends ExtAction {
        public UndoAction() {
            super("R�ckg�ngig", new ImageIcon("resources/images/EditUndo.gif"), "Macht die letzte Aktion r�ckg�ngig",
    ...
    private void createActions() {
        ...
        a.putValue(Action.SMALL_ICON, new ImageIcon("resources/images/EditCut.gif"));
        ...
        keyActions = keys.getKeyStrokesForAction(a);
        if (keyActions != null && keyActions.length > 0) a.putValue(ExtAction.KEYSTROKE, keyActions[0]);
        a.putValue(Action.SMALL_ICON, new ImageIcon("resources/images/EditCopy.gif"));
        ...
        keyActions = keys.getKeyStrokesForAction(a);
        if (keyActions != null && keyActions.length > 0) a.putValue(ExtAction.KEYSTROKE, keyActions[0]);
        a.putValue(Action.SMALL_ICON, new ImageIcon("resources/images/EditPaste.gif"));
