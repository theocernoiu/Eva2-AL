 ...
 * 2.031: Some updates to the OptimizerFactory. Review of the resources.MatlabInterface with adding an own options structure.
...
public class EvAInfo {
    ...
    public static final String propertyFile = "resources/EvA2.properties";
    public static final String LGPLFile = "resources/lgpl-3.0.txt";
    public static final String GPLFile = "resources/gpl-3.0.txt";
