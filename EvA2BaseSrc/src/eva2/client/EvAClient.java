...
//	private JFileChooser m_FileChooser;
    ...
    static {
        try {
            ClassLoader classLoader = EvAClient.class.getClassLoader();
            InputStream in = classLoader.getResourceAsStream(EvAInfo.propertyFile);

            EVA_PROPERTIES = new Properties();
            EVA_PROPERTIES.load(in);
